...
const ModalEliminarColaborador = () => {
    ...
    const { modalEliminarColaborador, handleModalEliminarColaborador, eliminarTarea, eliminarColaborador } = useProyectos()
                    ...
                    >
                            ...
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div className='mt-2'>
                                        <p className='text-sm text-gray-500'>Este colaborador ya no tendrá acceso a tu proyecto.</p>
                                    </div>
